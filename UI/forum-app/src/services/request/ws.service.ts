...
export class WsService {
  private readonly urlServer = "http://localhost:4002/forumhub";
  ...
  private _onNewCategorie = new BehaviorSubject<RegisterChannelResult>(
    undefined
  );
  ...
  private _onUserSubscribe = new BehaviorSubject<SubscribeResultView>(
    undefined
  );
